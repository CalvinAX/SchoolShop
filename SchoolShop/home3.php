...
<body>
    ...
    <main>
        ...
        $res = mysqli_query($con, "SELECT * FROM products ORDER BY prod_stock DESC LIMIT 24, 12");
    ...
    <div class="pagination">
        ...
        <div class="pagination-number"><i class="fa-solid fa-i"></i><i class="fa-solid fa-i"></i><i
                class="fa-solid fa-i"></i></div>
